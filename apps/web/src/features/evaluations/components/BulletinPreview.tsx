      ...
      <div className="mb-4 flex items-center gap-3 border-b border-line-soft pb-4">
        ...
        <div className="min-w-0 flex-1">
          ...
          <p className="text-xs font-semibold text-ink-soft">
            {bulletin.classCode} - {bulletin.term} - Matricule {bulletin.matricule}
          </p>
        </div>
        <div className="text-right">
          <p className="text-lg font-black text-brand-600">{bulletin.generalAverage.toFixed(2)}</p>
          <p className="text-xs font-semibold text-ink-faint">Moyenne /20</p>
        </div>
      </div>
        ...
        <table className="w-full">
          <thead>
            <tr className="border-b border-line-soft">
              ...
              <th className="px-2 py-2 text-center text-xs font-black text-ink-soft">Moy.</th>
