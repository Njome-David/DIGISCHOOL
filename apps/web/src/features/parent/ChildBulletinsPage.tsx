      ...
      {child && (
        <div className="flex items-center gap-3">
          ...
          <div>
            ...
            <p className="text-xs font-semibold text-ink-soft">Bulletins - {child.classCode}</p>
          </div>
        </div>
      )}
            ...
            return (
              <Card key={b.id} className="flex flex-wrap items-center gap-4">
                ...
                <div className="min-w-0 flex-1">
                  <h3 className="text-sm font-black text-ink">Bulletin - {b.term}</h3>
                  <p className="text-xs font-semibold text-ink-soft">
                    Moyenne {b.generalAverage.toFixed(2)}/20 - {b.mention}
                  </p>
                </div>
                {available ? (
                  ...
                  <Badge tone="neutral">
                    <Lock size={11} /> Pas encore publie
                  </Badge>
                )}
              </Card>
            );
